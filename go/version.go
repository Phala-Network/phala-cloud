...
const (
	...
	// kmsContractAPIVersion is the API version that exposes the contract-centric
	// KMS API. The contract methods pin it per request.
	kmsContractAPIVersion = "2026-06-23"
